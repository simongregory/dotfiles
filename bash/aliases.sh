...
alias ipd="cd ~/ip/ipd/"
alias imp="cd ~/ip/imp/"
alias bore="cd ~/ip/bore/"
alias pure="cd ~/ip/gel-pure/"
alias gel-pure="cd ~/ip/gel-pure/"
alias gel="cd ~/ip/gel/"
...
alias int="open https://www.int.bbc.co.uk/iplayer/"
alias int-ci="open https://ci-pal.int.bbc.co.uk/hudson/job/imp/"
